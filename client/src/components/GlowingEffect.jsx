...
// Aceternity GlowingEffect, adapted to plain JS. Uses framer-motion's animate
// (already a dependency) in place of the motion/react import.
function cn(...classes) {
...
const GlowingEffect = memo(function GlowingEffect({
  ...
  return (
    <>
      ...
      >
        <div className={cn('glowing-effect-glow', 'rounded-[inherit]')} />
      </div>
    </>
  )
})
